...
{
    public partial class GTienPhong : Form
    {
        public GTienPhong(string txt)
        {
            InitializeComponent();
        ...
        private void GTienPhong_Load(object sender, EventArgs e)
        {
        ...
        private void DocDS(List<MTienPhong> ds)
        {
            if (ds != null && ds.Count > 0)
            {
                ...
                dgv_qltienphong.Columns["TT"].Width = 30;
                dgv_qltienphong.Columns["SHD"].Width = 40;
            }
            else
                dgv_qltienphong.DataSource = null;
        }
        private void dgv_qltienphong_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow r = dgv_qltienphong.Rows[e.RowIndex];
            tbSHD.Text = r.Cells["SHD"].Value.ToString();
            cbbSoPhong.Text = r.Cells["Số phòng"].Value.ToString();
            cbbGiaPhong.Text = r.Cells["Giá phòng"].Value.ToString();
            tbSoThang.Text = r.Cells["Số tháng"].Value.ToString();
            cbbThang.Text = r.Cells["Tháng"].Value.ToString();
            tbTienPhong.Text = r.Cells["Tiền phòng"].Value.ToString();
            dtNgayThu.Text = r.Cells["Ngày thu tiền"].Value.ToString();
            dtThoiHan.Text = r.Cells["Thời hạn"].Value.ToString();
        ...
        private void btThem_Click(object sender, EventArgs e)
        {
            ...
            CTienPhong c = new CTienPhong();
            int dem = c.Insert(cbbSoPhong.Text, cbbGiaPhong.Text, tbSoThang.Text, cbbThang.Text, dtNgayThu.Text, dtThoiHan.Text, cbbMaSV.Text, tbMaNV.Text, cbbTT.Text);
            if (dem == -2)
            {
        ...
        private void btSua_Click(object sender, EventArgs e)
        {
            ...
            DataGridViewRow r = dgv_qltienphong.SelectedRows[0];
            CTienPhong c = new CTienPhong();
            int dem = c.Update(r.Cells["SHD"].Value.ToString(), cbbSoPhong.Text, cbbGiaPhong.Text, tbSoThang.Text, cbbThang.Text, dtNgayThu.Text, dtThoiHan.Text, cbbMaSV.Text, tbMaNV.Text,cbbTT.Text);
            if (dem == -2)
            {
        ...
        private void btTimKiem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dgv_qltienphong.DataSource == null)
                {
        ...
        private void btXuat_Click(object sender, EventArgs e)
        {
            ...
            //    exRange.Range["A1:A1"].ColumnWidth = 7;
             //   exRange.Range["B1:B1"].ColumnWidth = 15;
                ...
                sql = "select tb_HDTienPhong.SHD, tb_HDTienPhong.SoPhong, tb_SinhVien.MaSV, tb_SinhVien.TenSV, tb_SinhVien.DiaChi, tb_SinhVien.SDT, tb_HDTienPhong.NgayThuTien, tb_HDTienPhong.ThoiHan, tb_NhanVien.TenNV from tb_SinhVien, tb_HDTienPhong, tb_NhanVien" +
                    " where tb_HDTienPhong.MaSV = tb_SinhVien.MaSV and tb_HDTienPhong.MaNV = tb_NhanVien.MaNV and tb_HDTienPhong.SHD =N'" + tbSHD.Text + "'";
                ...
                if (tblThongTinHD.Rows.Count > 0)
                {
                    ...
                    exRange.Range["A7:A7"].Value = "Số phòng: ";
                    exRange.Range["B7:C7"].MergeCells = true;
                    exRange.Range["B7:C7"].Value = tblThongTinHD.Rows[0][1].ToString();

                    exRange.Range["A8:A8"].Value = "Mã sinh viên: ";
                    exRange.Range["B8:C8"].MergeCells = true;
                    exRange.Range["B8:C8"].Value = tblThongTinHD.Rows[0][2].ToString();

                    exRange.Range["A9:A9"].Value = "Tên sinh viên: ";
                    exRange.Range["B9:C9"].MergeCells = true;
                    exRange.Range["B9:C9"].HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignRight;
                    exRange.Range["B9:C9"].Value = tblThongTinHD.Rows[0][3].ToString();

                    //Thông tin khách hàng
                    exRange.Range["E6:E6"].Value = "Địa chỉ";
                    exRange.Range["F6:G6"].MergeCells = true;
                    exRange.Range["F6:G6"].Value = tblThongTinHD.Rows[0][4].ToString();
                    ...
                    exRange.Range["F7:G7"].Value = tblThongTinHD.Rows[0][5].ToString();
                     ...
                     exRange.Range["F8:G8"].Value = tblThongTinHD.Rows[0][6].ToString();
                    
                     exRange.Range["E9:E9"].Value = "Đến ngày: ";
                     exRange.Range["F9:G9"].MergeCells = true;
                     exRange.Range["F9:G9"].HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignRight;
                     exRange.Range["F9:G9"].Value = tblThongTinHD.Rows[0][7].ToString();
                    ...
                    exRange.Range["F17:F17"].Value = tblThongTinHD.Rows[0][8].ToString();
                }
                ...
                sql = "select SHD, SoPhong, GiaPhong, SoThang, Thang, GiaPhong * SoThang  as 'ThanhTien' from tb_HDTienPhong" +
                    " where SHD =N'" + tbSHD.Text + "'";
                ...
                if (tblThongTinDV.Rows.Count > 0)
                {
                    ...
                    exRange.Range["D11:D11"].Value = "Giá phòng";
                    exRange.Range["E11:E11"].Value = "Số tháng";
                    exRange.Range["F11:F11"].Value = "Tháng";
                    ...
                    exRange.Range["D13:G13"].Value = "Bằng chữ: " + ChuyenSo(tblThongTinDV.Rows[0][5].ToString());
                    exApp.Visible = true;
                }
            }
        }
